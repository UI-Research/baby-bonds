...
amt_df = left_join(
    ...
    select(sex, race, educ, taxstatus, p0, p10, p25, p50, p75, p90, p100)
...
>>>>>>> 3e9eed8cb6b4f83245e38623d462944d3470d347
    ...
    for( j in 1:dim(df)[1] ) {
        ...
        pctiles = as.integer(gsub('^p', '', names(p1)))
        probs   = pctiles/100
        quants  = as.numeric(p1)
        lens    = diff(pctiles)
        len_x   = 10
