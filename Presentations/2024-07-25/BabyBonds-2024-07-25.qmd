...
## Family Financial Wealth at 18 by Race/Ethnicity

```{r}
#| label: fig-finwealth-by-race-18
#| fig-cap: "Family financial wealth by race/ethnicity"

df = wealthdf |>
    select(raceeth, fam_fin_wealth, scenario) |>
    group_by(raceeth, scenario) |>
    summarise(
        fin_wealth_avg=mean(fam_fin_wealth),
        fin_wealth_med=median(fam_fin_wealth)
        ) |>
    recode_raceeth() |>
    recode_scenario() |>
    pivot_longer(
...
## Family Financial Wealth at 18 by Family Income at Birth

```{r}
#| label: fig-finwealth-by-lhincquin-18
#| fig-cap: "Family financial wealth by family income at birth"
...
df = wealthdf |>
    ...
    select(lhinc0quin, fam_fin_wealth, scenario) |>
...
## Family Net-Worth by Race/Ethnicity

```{r}
#| label: fig-networth-by-race-lhincquin-18
#| fig-cap: "Family networth by race/ethnicity"

df = wealthdf |>
    select(raceeth, fam_tot_wealth, scenario) |>
    group_by(raceeth, scenario) |>
    summarise(
        tot_wealth_avg=mean(fam_tot_wealth),
        tot_wealth_med=median(fam_tot_wealth)
        ) |>
    recode_raceeth() |>
    recode_scenario() |>
    pivot_longer(
        cols=c(tot_wealth_avg, tot_wealth_med), 
        names_prefix="tot_wealth_", 
        names_to="Statistic", 
        values_to="tot_wealth"
        ) |>
    mutate(Statistic=if_else(Statistic=="avg", "Mean", "Median"))
...
plot_by_scen(
    df,
    var=tot_wealth, 
    var_lab="Family net-worth (thousands of $2023)",
    class1=raceeth,
    class1_lab="Race/ethnicity",
    facet=~Statistic,
    scale=1e-3,
...
## Family Net-Worth by Race/Ethnicity (Restricted to dependent 18-year-olds)

```{r}
#| label: fig-networth-by-race-lhincquin-dep18
#| fig-cap: "Family networth by race/ethnicity for dependent 18-year-olds"
...
```
## Family Home Equity by Race/Ethnicity

```{r}
#| label: fig-homeeq-by-race-lhincquin-18
#| fig-cap: "Family home equity by race/ethnicity for dependent 18-year-olds"

df = wealthdf |>
    filter(yhead==0) |>
    select(raceeth, fam_tot_wealth, fam_fin_wealth, scenario) |>
    mutate(fam_hom_wealth=fam_tot_wealth-fam_fin_wealth) |>
    group_by(raceeth, scenario) |>
    summarise(
        hom_wealth_avg=mean(fam_hom_wealth),
        hom_wealth_med=median(fam_hom_wealth)
        ) |>
    recode_raceeth() |>
    recode_scenario() |>
    pivot_longer(
        cols=c(hom_wealth_avg, hom_wealth_med), 
        names_prefix="hom_wealth_", 
        names_to="Statistic", 
        values_to="hom_wealth"
        ) |>
    mutate(Statistic=if_else(Statistic=="avg", "Mean", "Median"))
...
plot_by_scen(
    df,
    var=hom_wealth, 
    var_lab="Family home equity (thousands of $2023)",
    class1=raceeth,
    class1_lab="Race/ethnicity",
    facet=~Statistic,
    scale=1e-3,
...
## Family Home Equity by Race/Ethnicity (Restricted to dependent 18-year-olds)

```{r}
#| label: fig-homeeq-by-race-lhincquin-dep18
#| fig-cap: "Family home equity by race/ethnicity"
...
## Share of People who Took a Student Loan by Family Income at Birth

```{r}
#| label: fig-share-stdebt-by-lhincquin-sex-45

df = microdf |>
    filter(age==45, degree>=3) |>
    select(lhinc0quin, male, scenario, weight, studdebt) |>
    mutate(hasdebt=(studdebt>0)) |>
    group_by(lhinc0quin, male, scenario) |>
    summarise(hasdebt=weighted.mean(hasdebt, weight)) |>
    ungroup() |>
...
## Average Student Loan Debt at College Exit among College Attendees by Quintile of Family Income at Birth and Sex

```{r}
#| label: fig-avg-stdebt-by-lhincquin-sex-45
#| fig-cap: "Average Student Loan Debt by Family Income at Birth and Sex"
...
## Average Student Loan Debt at College Exit Among Borrowers by Family Income at Birth and Sex

```{r}
#| label: fig-avg-stdebt-by-lhincquin-sex-45-brw
#| fig-cap: "Average Student Loan Debt by Family Income at Birth and Sex"
...
## Median Student Loan Debt at College Exit Among Borrowers by Quintile of Family Income at Birth and Sex

```{r}
#| label: fig-med-stdebt-by-lhincquin-sex-45-brw
#| fig-cap: "Median Student Loan Debt by Family Income at Birth and Sex"
...
## Homeownership by by Quintile of Family Income at Birth and Sex

```{r}
#| label: fig-homeown-by-lhincquin-sex-45
#| fig-cap: "Homeownership by Family Income at Birth and Sex"

df = microdf |>
    filter(age==45) |>
    select(lhinc0quin, male, scenario, weight, ownhome) |>
    group_by(lhinc0quin, male, scenario) |>
    summarise(
        ownhome = weighted.mean(ownhome, weight)
        ) |>
...
## Average Home Equity by by Quintile of Family Income at Birth and Sex

```{r}
#| label: fig-avg-homeeq-by-lhincquin-sex-45
#| fig-cap: "Home Equity by Family Income at Birth and Sex"

df = microdf |>
    filter(age==45 & ownhome==1) |>
    select(lhinc0quin, male, scenario, weight, homeeq) |>
    group_by(lhinc0quin, male, scenario) |>
    summarise(
        homeeq_avg = wtd.mean(homeeq, weight),
        homeeq_med = wtd.quantile(homeeq, weight, probs=.5)
...
## Median Home Equity by by Quintile of Family Income at Birth and Sex

```{r}
#| label: fig-med-homeeq-by-lhincquin-sex-45
#| fig-cap: "Median Home Equity by Family Income at Birth and Sex"
...
## Average Per-Capita Retirement Savings by Family Income at Birth and Sex

```{r}
#| label: fig-avg-retbal-by-lhincquin-sex-45
#| fig-cap: "Average Retirement Account Balance by Family Income at Birth and Sex"
...
## Median Per-Capita Retirement Savings by Family Income at Birth and Sex

```{r}
#| label: fig-med-retbal-by-lhincquin-sex-45
#| fig-cap: "Median Retirement Account Balance by Family Income at Birth and Sex"
...
* The effect of baby bonds on college education is small and positive for4 people from lower-income families and for Black and Hispanic people.
