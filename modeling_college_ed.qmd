...
model_formula = as.formula(paste("tEnroll ~ ", paste(model_covars3, collapse = " + ")))
...
estdf = estdf |>
    ...
    mutate(pred = map(mods, \(x) predict(x, type='response'))) |>
    mutate(
        margpnw1 = map2(mods, data, \(x,y) marginal_effects(x, y, variables=c("pnw1"))),
        margpnw2 = map2(mods, data, \(x,y) marginal_effects(x, y, variables=c("pnw2"))),
        margpnw3 = map2(mods, data, \(x,y) marginal_effects(x, y, variables=c("pnw3")))
        )
...
model_formula = as.formula(paste("tDrop ~ ", paste(model_covars2, collapse = " + ")))
...
model_formula = as.formula(paste("tGrad ~ ", paste(model_covars2, collapse = " + ")))
...
gsmodel_formula = as.formula(paste("tEnroll ~ ", paste(gsmodel_covars, collapse = " + ")))
...
gsmodel_formula = as.formula(paste("tEnroll ~ ", paste(model_covars2, collapse = " + ")))
