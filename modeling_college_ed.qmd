...
{
    df = map(colnames, ~data.frame(estdf[[.x]])) |> map(~setNames(.x, dyn_get_sexrace_names(estdf))) |> bind_rows()
...
tab_marg_effects(estdf, c("margpos", "margneg"))
...
tab_marg_effects(estdf, c("margpnw1","margpnw2","margpnw3"))
