...
#Double check on person-level ID
...
test <- read_rds('../data/dynasim_output_long.Rds')|>
    filter(pernum)|>
    group_by(pernum, year)|>
    summarize(gradecat)

# Creating comparable educational categories, race/ethnicity, and age categories
