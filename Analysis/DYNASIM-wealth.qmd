...
fehdir2 = "C:/Users/dcosic/Documents/Dynasim/Dynasim-core/run/output/output2/"
...
```{r}
#| label: fig-finwealth-dist
#| layout: [[1],[1,1]]
#| fig-cap: "Financial wealth over a lifetime for people born in 1990: cumulative distribution, mean, and standard deviation. (Source: DYNASIM4 Run1004 FEH, modified run 1004, and post-processing.)"
#| fig-subcap: 
