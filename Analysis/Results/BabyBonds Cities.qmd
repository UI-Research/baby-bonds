...
microdf = read_csv("X:/programs/Run1006(babybonds)/BabyBonds/BabyBondsData16Aug24.csv") |>
    rename_all(tolower)

wealthdf = read_csv("X:/programs/Run1006(babybonds)/BabyBonds/WealthData16Aug24.csv") |>
    rename_all(tolower)
